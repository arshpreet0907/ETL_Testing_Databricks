...
def apply_transforms(
    ...
    if dialect == 'snowflake':
        ...
        logger.debug('  [sf-coerce] process_start_ts: datetime/timestamp -> TimestampType (IST->UTC)')
        ...
        logger.debug('  [sf-coerce] process_end_ts: datetime/timestamp -> TimestampType (IST->UTC)')
