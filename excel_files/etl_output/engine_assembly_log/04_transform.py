...
def apply_transforms(
    ...
    if dialect == 'snowflake':
        ...
        logger.debug('  [sf-coerce] assembly_start_ts: datetime/timestamp -> TimestampType, null zero-datetimes')
        ...
        logger.debug('  [sf-coerce] assembly_end_ts: datetime/timestamp -> TimestampType, null zero-datetimes')
