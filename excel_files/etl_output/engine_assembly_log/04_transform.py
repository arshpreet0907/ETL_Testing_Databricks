...
def apply_transforms(
    ...
    if dialect == 'snowflake':
        ...
        logger.debug('  [sf-coerce] assembly_start_ts: datetime/timestamp -> TimestampType (no tz shift, MySQL stores local time)')
        ...
        logger.debug('  [sf-coerce] assembly_end_ts: datetime/timestamp -> TimestampType (no tz shift, MySQL stores local time)')
        ...
        logger.debug('  [sf-coerce] updated_at: datetime/timestamp -> TimestampType (no tz shift, MySQL stores local time)')
